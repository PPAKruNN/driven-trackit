    ...
    function FormLogin(event) {
        ...
        loginUser({email, password})
            ...
            .catch( () => {
                ...
                alert("O login deu ruim ein!")
                setLoading(false);
            });
    

            // TODO:
            // PEGAR DADOS RETORNADOS PELA API E MANDAR O USUARIO PARA DENTRO DA APLICACAO!!!!
            // LOGIN/CADASTRO JA ESTAO COMPLETOS, VA PARA OUTRAS TELAS!!!
    }
